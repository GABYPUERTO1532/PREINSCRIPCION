...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-09-2022 a las 23:04:02
...
ALTER TABLE `students`
  ...
  ADD CONSTRAINT `students_ibfk_15` FOREIGN KEY (`stu_cit`) REFERENCES `cities` (`cit_nam`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `students_ibfk_16` FOREIGN KEY (`stu_dep`) REFERENCES `departaments` (`dep_nam`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `students_ibfk_18` FOREIGN KEY (`exp_cit`) REFERENCES `cities` (`cit_nam`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `students_ibfk_19` FOREIGN KEY (`stu_nei`) REFERENCES `neigh` (`neig_nam`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `students_ibfk_20` FOREIGN KEY (`stu_loc`) REFERENCES `locations` (`loc_nam`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `students_ibfk_21` FOREIGN KEY (`stu_ars`) REFERENCES `ars` (`ars_nam`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `students_ibfk_22` FOREIGN KEY (`doc_typ`) REFERENCES `doc_typ` (`doc_typ`) ON DELETE CASCADE ON UPDATE CASCADE,
